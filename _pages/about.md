...
Together with [Alessio Franci](https://sites.google.com/site/francialessioac/) we are organizing a week-long summer course on the theme of "Fast and flexible multi-agent decision-making" through the International Graduate School on Control organized by the European Embedded Control Institute. In the course, hosted in Liege, Belgium, in May, we will explore the theory and application of multistability, bifurcation, and excitability for fast and flexible autonomous decision-making in uncertain and dynamic environments. This is a great opportunity for graduate students with an interest in nonlinear systems, bio-inspired and neuromorphic control, and autonomy! **The early registration deadline is *March 15th* - see [http://www.eeci-igsc.eu/](http://www.eeci-igsc.eu/) for more information.**
